...
import '../pages/inventaris/inventaris_pakan/add_name_and_feed_screens/edit_pakan.dart';
import 'convert_to_rupiah_widget.dart';
import 'new_Menu_widget.dart';

class NewRenderInventarisPakanListWidget extends StatefulWidget {
  const NewRenderInventarisPakanListWidget({Key? key}) : super(key: key);
  @override
  State<NewRenderInventarisPakanListWidget> createState() =>
      _NewRenderInventarisPakanListWidgetState();
}

class _NewRenderInventarisPakanListWidgetState
    extends State<NewRenderInventarisPakanListWidget> {
      ...
      children: [
        Column(
          children: [
            ...
            Obx(() => state.customFeedList.value.data!.isEmpty
                ? SizedBox(
                    height: 100,
                    child: Center(
                      child: Text(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [ListView.builder(
                          ...
                          itemCount: state.customFeedList.value.data!.length,
                            ...
                            return GestureDetector(
                              onTap: () async {
                                ...
                                await state.getDataByID(
                                    state.customFeedList.value.data![index].idInt!, () {
                                  state.getDetailPakanNameData(
                                      state.customFeedList.value.data![index].feed!
                                          .idInt!, () {
                                    // getPakanBottomSheet(index,
                                    //     state.customFeedList.value.data![index].idInt!);
                                    Get.to(()=> EditPakan(index: index, id: state.customFeedList.value.data![index].idInt!));
                                  });
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            state.dateFormat(
                                                state.customFeedList.value.data![index]
                                                    .createdAt!
                                                    .toString(),
                                                true),
                                            style: headingText3,
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            children: [
                                              ...
                                              SizedBox(height: 6),
                                              Text(
                                                '${state.customFeedList.value.data![index].amount!.toStringAsFixed(2)} kg',
                                                style: TextStyle(
                                                  color: Colors.grey.shade500,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 12,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Rp${ConvertToRupiah.formatToRupiah(state.customFeedList.value.data![index].price!)}',
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 14,
