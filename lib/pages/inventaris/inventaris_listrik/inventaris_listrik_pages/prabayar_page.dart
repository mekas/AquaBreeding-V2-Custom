...
import 'package:fish/pages/inventaris/inventaris_listrik/add_or_edit_electricity_usage/edit_electricity_usage.dart';
                            ...
                            return GestureDetector(
                              onTap: () async {
                                ...
                                await state.getDataByID(
                                  ...
                                  //     state.electricList.value.data![index]
                                  //         .idInt!);
                                  Get.to(() => EditElectricityUsage(index: index, id: state.electricList.value.data![index]
                                      .idInt!));
                                });
                              },
                              child: Container(
