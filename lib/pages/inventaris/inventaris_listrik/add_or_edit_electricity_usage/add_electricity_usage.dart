...
class AddElectricityUsage extends StatefulWidget {

  const AddElectricityUsage({super.key});

  @override
  State<AddElectricityUsage> createState() => _AddElectricityUsageState();
}

class _AddElectricityUsageState extends State<AddElectricityUsage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Catat Listrik'),
        actions: [
          IconButton(
            onPressed: () {
