...
import '../../treatment/treatment_type_controller.dart';
import 'inventaris_pakan_state.dart';

class PakanCustomController extends GetxController {
  ...
  TextEditingController obatController = TextEditingController(text: '0');

  TextEditingController probioticController2 = TextEditingController(text: '0');
  TextEditingController carbonController2 = TextEditingController(text: '0');
  TextEditingController obatController2 = TextEditingController(text: '0');

  TextEditingController probioticController3 = TextEditingController(text: '0');
  TextEditingController carbonController3 = TextEditingController(text: '0');
  TextEditingController obatController3 = TextEditingController(text: '0');

  TextEditingController probioticController4 = TextEditingController(text: '0');
  TextEditingController carbonController4 = TextEditingController(text: '0');
  TextEditingController obatController4 = TextEditingController(text: '0');

  TextEditingController probioticController5 = TextEditingController(text: '0');
  TextEditingController carbonController5 = TextEditingController(text: '0');
  TextEditingController obatController5 = TextEditingController(text: '0');
  ...
  final fitur = 'Catat Pakan Custom';
